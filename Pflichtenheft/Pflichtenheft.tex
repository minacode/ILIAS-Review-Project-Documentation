...
\item Nach Bearbeitung einer reviewbaren Frage werden automatisch neue Reviews angefordert.
...
\end{itemize}
Das fünfte Kannkriterium sind Standard-Bemerkungen:
\begin{itemize}
\item Bei dem Erstellen eines Reviews sollen einfache Bemerkungen durch Klicken hinzufügbar sein.
\item Die Bemerkung wird automatisch in das Bemerkungsfeld eingefügt. 
\end{itemize}
